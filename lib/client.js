    ...
    return Promise.race([
        ...
        new Promise(function (resolve, reject) {
            timeoutRef = setTimeout(function () {
              var err = new Error('Promise timed out.');
              err.reason = {
                    id: id,
                    type: 'error',
                    error: {
...
function Client(opts) {
    ...
    this.stanzas.use(require('@konradkierus/jxt-xmpp'));
    ...
    request = new Promise(function (resolve, reject) {
        var handler = function (res) {
            ...
            if (!res.error) {
                ...
                var err = new Error(res.error && res.error.condition ? res.error.condition : 'Request failed with no specified condition.');
                err.reason = res;
                reject(err);
            }
        };
